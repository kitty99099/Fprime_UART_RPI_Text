// ======================================================================
// \title  UART_Input_OutputTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef UART_INPUT_OUTPUT_UART_INPUT_OUTPUTTOPOLOGY_HPP
#define UART_INPUT_OUTPUT_UART_INPUT_OUTPUTTOPOLOGY_HPP
// Included for access to UART_Input_Output::TopologyState and UART_Input_Output::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <UART_Input_Output/Top/UART_Input_OutputTopologyDefs.hpp>

// Remove unnecessary UART_Input_Output:: qualifications
 ...
 * UART_Input_Output::TopologyState see: UART_Input_OutputTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type UART_Input_Output::TopologyState see: UART_Input_OutputTopologyDefs.hpp.
 *
