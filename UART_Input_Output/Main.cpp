...
#include <UART_Input_Output/Top/UART_Input_OutputTopology.hpp>
...
static void signalHandler(int signum) {
    UART_Input_Output::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    UART_Input_Output::TopologyState inputs;
    ...
    UART_Input_Output::setupTopology(inputs);
    UART_Input_Output::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    UART_Input_Output::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
