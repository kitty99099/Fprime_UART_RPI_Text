// ======================================================================
// \title  UART_Input_OutputTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <UART_Input_Output/Top/UART_Input_OutputTopologyAc.hpp>
#include <UART_Input_Output/Top/UART_Input_OutputPacketsAc.hpp>
...
using namespace UART_Input_Output;
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(UART_Input_OutputPacketsPkts, UART_Input_OutputPacketsIgnore, 1);
    ...
    //bool gpio_success = gpioDriver.open(526, Drv::LinuxGpioDriver::GpioDirection::GPIO_OUT);
    //if (!gpio_success) {
    //    Fw::Logger::logMsg("[ERROR] Failed to open GPIO pin\n");
    //}

    bool uart_success = UART_Input_Output::serialDriver.open("/dev/ttyUSB0",
    ...
    if(uart_success){
        ...
        UART_Input_Output::serialDriver.startReadThread(); // where the error happens
    } else {
...
// Public functions for use in main program are namespaced with deployment name UART_Input_Output
namespace UART_Input_Output {
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        UART_Input_Output::blockDrv.callIsr();
